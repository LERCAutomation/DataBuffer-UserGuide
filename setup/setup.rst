...
Once it is installed, it will become available to add to the ArcGIS interface as a button (see `Customising toolbars in ArcGIS <CustomisingToolbarsArcGIS>`_).
