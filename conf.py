# -*- coding: utf-8 -*-
#
# DataBuffer-UserGuide documentation build configuration file, created by
...
html_short_title = 'Data Buffer User Guide'
...
htmlhelp_basename = 'DataBuffer-UserGuidedoc'
